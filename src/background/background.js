...
chrome.runtime.onMessage.addListener((request, sender, sendResponse) => {
    ...
    if (request.action === "clickNode") {

        twpConfig.addKeyWordTocustomDictionary("fffffffffffffff", request.eventData.target);


        console.error("Event type:", request.eventData.target);
        console.error("Event type:", request.eventData.classList);

        // console.error("Event type:", request.eventData.type);
        // console.error("Event target:", request.eventData.target);
        // console.error("Event currentTarget:", request.eventData.currentTarget);
